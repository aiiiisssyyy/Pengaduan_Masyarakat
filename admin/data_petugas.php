                                    ...
                                    <div class="modal-body">
                                        <form action="" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" name="telp" class="form-control" placeholder="Masukkan No. Telp" required>
                                                </div>
                                            </div>
            ...
            <table class="table table-strip">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php $data['id_petugas'] ?>">HAPUS</a>
                                <!-- Modal HAPUS-->
                                <div class="modal fade" id="hapus<?php $data['id_petugas'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
