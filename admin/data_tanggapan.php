            ...
            <table class="table table-strip">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php $data['id_tanggapan'] ?>">HAPUS</a>
                                <!-- Modal HAPUS-->
                                <div class="modal fade" id="hapus<?php $data['id_tanggapan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
