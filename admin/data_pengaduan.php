                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#verifikasi<?php $data['id_pengaduan'] ?>">VERIFIKASI</a>
                                <!-- Modal VERIFIKASI-->
                                <div class="modal fade" id="verifikasi<?php $data['id_pengaduan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Verifikasi : <?php echo $data['judul_laporan'] ?></h5>
                                ...
                                <?php 
                                if($data['status'] == 'proses') { ?>
                                <a href="" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#tanggapi<?php $data['id_pengaduan'] ?>">TANGGAPI</a>
                                <!-- Modal TANGGAPAN-->
                                <div class="modal fade" id="tanggapi<?php $data['id_pengaduan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Tanggapi : <?php echo $data['judul_laporan'] ?></h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="" method="POST">
                                ...
                                <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php $data['id_pengaduan'] ?>">HAPUS</a>
                                <!-- Modal HAPUS-->
                                <div class="modal fade" id="hapus<?php $data['id_pengaduan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
